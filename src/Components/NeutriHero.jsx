...
const NutritionHero = () => {
  ...
  const handleStart = () => {
    navigate('/analyze'); // ✅ use react-router navigation
  };
      ...
      <nav className="relative z-50 px-6 py-6">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <button
              className="px-6 py-2 bg-gradient-to-r from-emerald-500 to-cyan-500 rounded-full hover:from-emerald-600 hover:to-cyan-600 transition-all transform hover:scale-105 cursor-pointer"
              onClick={handleStart}
            >
              Get Started
            </button>
        ...
        {isMenuOpen && (
          <div className="md:hidden absolute top-full left-0 right-0 bg-gray-900/95 backdrop-blur-lg border-t border-gray-700/50 p-6">
            <div className="space-y-4">
              ...
              <button
                onClick={handleStart}
                className="w-full px-6 py-3 bg-gradient-to-r from-emerald-500 to-cyan-500 rounded-full hover:from-emerald-600 hover:to-cyan-600 transition-all"
              >
                Get Started
              </button>
            </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-20 pb-32">
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6 mb-16">
            <button
              className="group px-8 py-4 bg-gradient-to-r from-emerald-500 to-cyan-500 rounded-full hover:from-emerald-600 hover:to-cyan-600 transition-all transform hover:scale-105 shadow-2xl shadow-emerald-500/25 cursor-pointer"
              onClick={handleStart}
            >
